...
The cable and conduit targets were not completely surrounded by the Penlight apparatus, which had openings at its ends. Therefore, the exposing temperature ramp $T_{\rm ramp}$ was calculated using a view factor of 0.90 and the experimentally measured shroud temperature.
...
Test              &  Diameter  &  Unit Length  &  Thickness  &  Diameter  &  Thickness  &  $T_\infty$       &  $t_{\rm end}$  \\
...
\hline
                  &                                &                             \\
\rb{Test}         &  \rb{$t_{\rm ramp}$}             &  \rb{$T_{\rm ramp}$}          \\
...
\hline
           &                    &                 &                 &                        &                    \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$\dot m$}  &  \rb{$T_\infty$}       &  \rb{$t_{\rm end}$}  \\
...
\hline
           &                    &                 &            &            &            &                 &                        &                    \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$L$}  &  \rb{$W$}  &  \rb{$H$}  &  \rb{$\dot m$}  &  \rb{$T_\infty$}       &  \rb{$t_{\rm end}$}  \\
...
\hline
           &                    &                 &                 &                  &                  &                        &                    \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$\dot m$}  &  \rb{$H_{\rm o}$}  &  \rb{$W_{\rm o}$}  &  \rb{$T_\infty$}       &  \rb{$t_{\rm end}$}  \\
...
\hline
           &                 &                     &                \\
\rb{Test}  &  \rb{$\dot Q$}  &  \rb{$\chi_{\rm r}$}  &  \rb{$A$}      \\
           &  \rb{(kW)}      &                     &  \rb{(m$^2$)}  \\ \hline \hline
...
The fire growth was specified as $\dot Q = \alpha t^2$ up to a cutoff time of $t_{\rm fire}$.
After the time $t_{\rm fire}$, the fire HRR was steady.
...
\rb{Input Parameter}              &  \rb{Value}  \\ \hline \hline
Location Factor                   &  1           \\ \hline
$t_{\rm fire}$ (s)                  &  300         \\ \hline
$\Delta T_{\rm c}$ (\si{\celsius})  &  10          \\ \hline
...
\hline
           &                    &                    \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$t_{\rm end}$}  \\
           &                    &  \rb{(s)}          \\ \hline \hline
...
The HGL temperatures from the MQH HGL temperature correlation were used as the input fire temperature~$T_{\rm f}$.
...
\hline
                            &              \\
\rb{Input Parameter}        &  \rb{Value}  \\ \hline \hline
$\rho_{\rm s}$ (kg/m$^3$)     &  7833        \\ \hline
$c_{\rm s}$ (\si{kJ/(kg.K)})  &  0.465       \\ \hline
$\epsilon$                  &  0.7         \\ \hline
$h_{\rm c}$ (\si{W/(m^2.K)})  &  25          \\ \hline
\end{tabular}
\end{center}
...
\hline
           &                      &              &                    \\
\rb{Test}  &  \rb{Correlation}    &  \rb{F/V}    &  \rb{$t_{\rm end}$}  \\
           &  \rb{for $T_{\rm f}$}  &  \rb{(1/m)}  &  \rb{(s)}          \\ \hline \hline
...
The HGL temperatures from the McCaffrey plume temperature correlation were used as the input fire temperature~$T_{\rm f}$.
...
\hline
                &                      &                 &                    \\
\rb{Test}       &  \rb{Correlation}    &  \rb{$\dot Q$}  &  \rb{$t_{\rm end}$}  \\
                &  \rb{for $T_{\rm f}$}  &  \rb{(kW)}      &  \rb{(s)}          \\ \hline \hline
...
\hline
           &                    &                 &                  &                  &                        \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$H_{\rm o}$}  &  \rb{$W_{\rm o}$}  &  \rb{$T_{\infty}$}     \\
...
\hline
           &                     &            &            &                     &            \\
\rb{Test}  &  \rb{$t_{\rm fire}$}  &  \rb{$r$}  & \rb{Test}  &  \rb{$t_{\rm fire}$}  &  \rb{$r$}  \\
...
\hline
           &                   &                     &                  &                &                        \\
\rb{Test}  &  \rb{$\alpha$}    &  \rb{$t_{\rm fire}$}  &  \rb{$\dot Q$}   &  \rb{$A$}      &  \rb{$T_\infty$}       \\
...
\hline
           &                   &                     &             &                 &                        \\
\rb{Test}  &  \rb{$\alpha$}    &  \rb{$t_{\rm fire}$}  &  \rb{$r$}   &  \rb{Location}  &  \rb{$T_\infty$}       \\
...
The fire ramp was specified as $\dot Q_{\rm ramp}$ with a corresponding $t_{\rm ramp}$.
For example, a fire growing linearly over time 0~s to 100~s from 0~kW to 500~kW
would be specified with a $t_{\rm ramp}$ of [0, 100] and a $\dot Q_{\rm ramp}$ of [0, 500].
...
\hline
           &                                  &                                            &                &                        \\
\rb{Test}  &  \rb{$t_{\rm ramp}$}               &  \rb{$\dot Q_{\rm ramp}$}                    &  \rb{$A$}      &  \rb{$T_\infty$}       \\
...
\hline
           &                    &                 &                    &                        \\
\rb{Test}  &  \rb{Correlation}  &  \rb{$\dot Q$}  &  \rb{$t_{\rm end}$}  &  \rb{$T_\infty$}       \\
...
\hline
                            &              \\
\rb{Input Parameter}        &  \rb{Value}  \\ \hline \hline
$\rho_{\rm s}$ (kg/m$^3$)     &  7860        \\ \hline
$c_{\rm s}$ (\si{kJ/(kg.K)})  &  0.450       \\ \hline
$\epsilon$                  &  0.7         \\ \hline
$h_{\rm c}$ (\si{W/(m^2.K)})  &  25          \\ \hline
\end{tabular}
\end{center}
...
\rb{Test}  &  \rb{Correlation}    &  \rb{Structural}  &  \rb{F/V}    \\
           &  \rb{for $T_{\rm f}$}  &  \rb{Element}     &  \rb{(1/m)}  \\ \hline \hline
...
\rb{Input Parameter}        &  \rb{Value}  \\ \hline \hline
$c_{\rm s}$ (\si{kJ/(kg.K)})  &  0.450       \\ \hline
$k_{\rm i}$ (\si{W/(m.K)})    &  0.10        \\ \hline
$\rho_{\rm i}$ (kg/m$^3$)     &  208         \\ \hline
$c_{\rm i}$ (\si{kJ/(kg.K)})  &  2.0         \\ \hline
\end{tabular}
\end{center}
...
\hline
           &                      &                   &                  &                   \\
\rb{Test}  &  \rb{Correlation}    &  \rb{Structural}  &  \rb{$h_{\rm i}$}  &  \rb{W/D}         \\
           &  \rb{for $T_{\rm f}$}  &  \rb{Element}     &  \rb{(m)}        &  \rb{(kg/m$^2$)}  \\ \hline \hline
