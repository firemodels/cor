...
For a steady-state fire, the correlation of Alpert~\cite{SFPE:Alpert} predicts that the ceiling jet temperature rise, $\Delta T_{\rm jet}$~(\si{\celsius}), from a fire plume is given by
\be
\Delta T_{\rm jet} = \left\{ \begin{array}{cl}
