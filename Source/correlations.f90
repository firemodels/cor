...
REAL :: ACTIVATION_TEMPERATURE,A_C,ALPHA,AREA,A_T,A_V,C_I,CONDUIT_DIAMETER,CONDUIT_THICKNESS,CUTOFF_TIME,C_PL,C_CJ, &
        ...
        K_I,K_S,L,LOCATION_FACTOR,L_F,MASS_PER_LENGTH,M_DOT,P,Q,Q_STEP,R,RADIATIVE_FRACTION,RHO_A, &
...
REAL :: R,Q_RAD(20),Q_RAD_SOLID(20),E,E2,S,H1,H2,A1,A2,F_12_V1,F_12_V2,F_12_H,F_12_V,F_12,A,B
INTEGER :: I,K,N_X,N_Z
CHARACTER(30) :: FMT
...
RHO_A = 353./(273.15+20.)
D = SQRT(4.*AREA/PI)
L_F = 0.235*Q**0.4-1.02*D

! EMISSIVE POWER CALCULATION
E = 58*(10**(-0.00823*D))
E2 = RADIATIVE_FRACTION*Q / (PI * D * L_F)
E = MIN(E,E2)
